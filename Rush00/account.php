...
<html>
	...
	<body>
		<center><a href="./user/modif.html">Nouveau mot de passe</a><a href="./">Acceuil</a><a title="Attention, ceci ne supprimera pas vos donn&eacute;es de commande"href="./user/account_del.php">D&eacute;sactiver le compte</a></center>
		<center><?php
			if ($tab)
			{
				foreach ($tab as $id)
