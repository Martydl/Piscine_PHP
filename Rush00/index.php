...
<html>
	<head>
		...
		<center><div id="catmenu">
			<ul class="niveau1">
				<li class="sous-menu"><span class=cattitle>Genres</span>
					<ul class="niveau2">
						<?php
		...
		<div class="image-sliderfade fade">
		<a href="index.php?cat=Rap"><img src="https://static.fnac-static.com/multimedia/Images/FR/NR/5e/84/a8/11043934/1540-1/tsp20190322122034/Phoenix.jpg" style="width:100%">
